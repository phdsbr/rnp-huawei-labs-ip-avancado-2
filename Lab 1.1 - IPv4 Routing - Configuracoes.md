...
- O conteúdo abaixo consolida a configura��o final desejada do laboratório.
...
## Comandos Temporários de Validação do BFD no PE2

Esses comandos aparecem no roteiro apenas para simular falha e observar a converg�ncia. Eles n�o fazem parte da configura��o final permanente.
